 ...
 * proven at validate-core.js in this same directory, and at export-core.js
 * in public/sondrik/data, public/alpha/data, public/garage/data, and
 * public/cgt/data.
 *
 * csvField carries a real security guard (CSV/formula injection, OWASP):
 * the Export CSV button on this page runs every field through it before it
 * ever touches a downloaded file. Sondrik, Alpha, Garage, and CGT already
 * extracted the identical function into their own tested core files; this
 * closes the same gap for Job Search, which had it copied into app.js
 * untested.
 */
(function (root, factory) {
  if (typeof module === 'object' && module.exports) {
    ...
    root.JobSearchExportCore = factory();
  }
