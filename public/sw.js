...
const SHELL_URLS = [
  ...
  '/vendor/d3-force-selection-zoom.min.js', '/sidebar.js', '/data/dashboard-core.js',
  ...
  '/sondrik/data/goals-core.js', '/sondrik/data/release-core.js',
