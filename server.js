...
// Real money math (drawdown %, account P&L, position/equity mapping), moved
// out to public/alpha/data/live-core.js so it gets the same regression-test
// coverage as every other hub's own *-core.js: this was the one hub whose
// real dollar figures were computed entirely inline in server.js with zero
// test coverage anywhere, the exact gap account-core.js's own header comment
// already flags for the client-side half of this same feed.
const { computeDrawdowns, mapPositions, mapAccount, mapEquityCurve } = require('./public/alpha/data/live-core.js');
