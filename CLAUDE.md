...
- `npm run test:sondrik` — Sondrik's own regression tests for its shared date-math (`goals-core.js`, `release-core.js`, `validate-core.js`), CSV/ICS export helpers (`export-core.js`), and Next Steps checklist logic (`next-steps-core.js`); run after touching any of them
