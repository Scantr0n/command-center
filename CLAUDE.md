...
- `npm run test:sondrik` — Sondrik's own regression tests for its shared date-math (`goals-core.js`, `release-core.js`, `validate-core.js`) and CSV/ICS export helpers (`export-core.js`); run after touching any of them
